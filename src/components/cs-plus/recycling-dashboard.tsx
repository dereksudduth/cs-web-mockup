...
import { Recycle, Package, Leaf, ArrowUp } from '@phosphor-icons/react';
        ...
        >
          <Card className="overflow-hidden">
            <CardContent className="p-6">
              ...
              <div className="mt-4">
                <Progress value={DIVERSION_RATE} className="h-2" />
              ...
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Legend 
                    ...
                    height={36}
                    content={({ payload }) => (
                      <ul className="flex items-center justify-center gap-6 pt-8">
                        {payload?.map((entry: any, index: number) => (
                          <li key={`legend-${index}`} className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-neutral-600">
                              {entry.value} ({RECYCLING_DATA[index].value}%)
                            </span>
                          </li>
                        ))}
                      </ul>
